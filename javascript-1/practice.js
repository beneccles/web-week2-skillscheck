...
// Check to see if the number is even or odd. If it is odd, return 'the number is odd' 
// or return 'the number is even' if it is even.
...
myNumbers.forEach(function (x, index) {
...
// Code Here
let forTheLoveOfGeorge = notGeorge.map(function(x) {
	return x = "George";
});
...
// Code Here
let enemies = people.filter(function(x){
	if (x.friend === true){
		return;
	}
	else {
